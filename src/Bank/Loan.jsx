...
import personal from '../Bank/personal.jpg'
import gold from '../Bank/gold.jpg'
import agriculture from '../Bank/agriculture.jpg'
import microfinance from '../Bank/microfinance.jpg'
...
const Home = () => {
    return (
        <Container>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href='#'>Loan</a>
                            </li>
                            <li class="nav-item">
            ...
            <div className="loans">
                <div className="boxes">
                    <img src={personal} width={280} height={200} alt="" />
                    <div className="line"></div>
                    <a href="/PersonalLoan"><h3>Personal Loan</h3></a>
                </div>
                <div className="boxes">
                    <img src={gold} width={280} height={200} alt="" />
                    <div className="line"></div>
                    <a href="/GoldLoan"><h3>Gold Loan</h3></a>
                </div>
                <div className="boxes">
                    <img src={agriculture} width={280} height={200} alt="" />
                    <div className="line"></div>
                    <a href="/AgricultureLoan"><h3>Agriculture Loan</h3></a>
                </div>
                <div className="boxes">
                    <img src={microfinance} width={280} height={200} alt="" />
                    <div className="line"></div>
                    <a href="/Microfinance"><h3>Micro finance</h3></a>
                </div>
            </div>
